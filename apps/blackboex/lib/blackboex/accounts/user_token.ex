defmodule Blackboex.Accounts.UserToken do
  @moduledoc """
  Schema and token generation/verification for user sessions and email tokens.
  """
  use Ecto.Schema
  import Ecto.Query
  ...
  """
  @spec build_email_token(Blackboex.Accounts.User.t(), String.t()) :: {String.t(), %UserToken{}}
