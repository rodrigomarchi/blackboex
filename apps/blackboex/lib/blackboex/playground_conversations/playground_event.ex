defmodule Blackboex.PlaygroundConversations.PlaygroundEvent do
  @moduledoc """
  Atomic event within a `PlaygroundRun`. Each row captures one chat message,
  code delta, or terminal signal in the conversation timeline.
  ...
  @valid_event_types ~w(user_message assistant_message code_delta completed failed)

  @primary_key {:id, :binary_id, autogenerate: true}
  @foreign_key_type :binary_id
  schema "playground_events" do
    field :sequence, :integer
    field :event_type, :string
    field :content, :string
    field :metadata, :map, default: %{}

    belongs_to :run, Blackboex.PlaygroundConversations.PlaygroundRun
