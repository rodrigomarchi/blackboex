defmodule BlackboexWeb.Telemetry do
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("blackboex.repo.query.total_time",
        unit: {:native, :millisecond},
        description: "The sum of the other measurements"
      ),
      summary("blackboex.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("blackboex.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("blackboex.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("blackboex.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
