defmodule BlackboexWeb.DashboardLive.OverviewTest do
  @moduledoc """
  Tests for the dashboard Overview LiveView in both org and project scopes.
  """
  ...
  describe "org scope at /orgs/:slug/dashboard" do
  ...
  describe "project scope at /orgs/:slug/projects/:slug/dashboard" do
    test "renders project-scoped stats and nav", %{
      ...
      {:ok, _lv, html} =
        live(conn, ~p"/orgs/#{org.slug}/projects/#{project.slug}/dashboard")
      ...
      assert html =~ "/orgs/#{org.slug}/projects/#{project.slug}/dashboard/apis"
    end
