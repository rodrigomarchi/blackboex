...
config :esbuild,
  ...
  blackboex_web: [
    args:
      ~w(js/app.js --bundle --target=es2022 --outdir=../priv/static/assets/js --external:/fonts/* --external:/images/* --alias:@=. --log-override:equals-new-object=silent),
...
config :blackboex, Oban,
  repo: Blackboex.Repo,
  queues: [billing: 10, analytics: 5, generation: 3, flows: 5],
  plugins: [
    Oban.Plugins.Pruner,
    {Oban.Plugins.Cron,
     crontab: [
